sap.ui.define([ "sap/ui/core/Control" ], function(Control) {
	"use strict";
	return Control.extend("hydrofoil.js.ThreejsContainer", {
		metadata : {
			properties : {
				matrix : {
					type : "string",
		...
		That : {},
		init : function() {
			jQuery.sap.require('hydrofoil/js/jsondata');
			jQuery.sap.require('hydrofoil/js/three');
			jQuery.sap.require('hydrofoil/js/math');
			jQuery.sap.require('hydrofoil/js/TrackballControls');
		...
		renderer : function(oRm, oControl) {
			...
			oRm.write("</div>");
			// if(oControl.renderer!=undefined)
			// oControl.renderer.render(
